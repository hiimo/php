...
echo $aeg;
?>
<h2>sisesta aasta kuu ja kuupäev</h2>
<form method="GET">
    <input type="number" name="sunniaasta" placeholder="Aasta" required min="1500" max="<?php echo date("Y"); ?>"><br><br>
...
echo "2024 kooliaasta lõpuni on jäänud $paevalles päeva!";
?>
...
if (!empty($_GET["aastaaeg"])) {
    ...
    if ($imageSource) {
        echo "<img src=\"$imageSource\" alt=\"$aastaaeg\" style='width:200px;'><br>";
    } else {
        echo "Vali aastaaeg";
    }
}
